  ...
  it('shows on the targeted iOS TestFlight release', () => {
    expect(
      shouldShowTestFlightAppStoreMigrationBanner({
        isIOS: true,
        isTestFlight: true,
        releaseVersion: '1.127.1',
      }),
    ).toBe(true)
  })

  it.each([
    {isIOS: true, isTestFlight: true, releaseVersion: '1.127.2'},
    {isIOS: false, isTestFlight: true, releaseVersion: '1.127.1'},
    {isIOS: true, isTestFlight: false, releaseVersion: '1.127.1'},
